...
#'
#' A total of 200 subject receiving 4 treatments randomly but with unequal chance, the allocation is 1:1:1:7
#'
#' \itemize{
...
#' @docType data
#' @name simu.dat
#' @format A list of 4 items. X: 200x30 matrix indicating 200 subjects and 30 covariate (but only part of them is related)
#'
"simu.dat"
